...
// Helpers
import { backgroundArray, birdArray, birdNames, mainColorArray, customModalStyles, btn_animation, removeBtnStyle } from "../../config";
    ...
    return (
        <div className={container}>
            <header className={header}>
                ...
                <Modal 
                    isOpen={showModalBurger} 
                    onRequestClose={handleCloseModalBurger} 
                    contentLabel="Burger Modal" 
                    className={customModalStyles}>
                    <BurgerMenu 
                        mainColor={mainColor} 
                        handleCloseModalBurger={handleCloseModalBurger} 
                        playPop={playPop}
                    />
                </Modal>
            </header>
            <main className={ mainContent }>
                ...
                <Breadcrumb 
                    birdIndex={birdIndex} 
                    handleOnCrumbClick={handleOnCrumbClick} 
                    playPop={playPop} 
                />
            </main>
        </div>
